...
hi Number cterm=NONE ctermfg=255  ctermbg=black gui=NONE guifg=#d0d0d0 guibg=#0a0a0a
hi Error cterm=NONE ctermfg=255 ctermbg=DarkGray gui=NONE guifg=#eeeeee guibg=#0a0a0a
hi ErrorMsg cterm=NONE ctermfg=255 ctermbg=DarkGray gui=underline guifg=#eeeeee guibg=#0a0a0a
hi Search cterm=NONE ctermfg=245 ctermbg=Gray guifg=#000000 guibg=#eeeeee
...
hi StatusLine cterm=bold,reverse ctermfg=245 ctermbg=NONE gui=bold,reverse guifg=#0a0a0a guibg=#bcbcbc
hi StatusLineNC cterm=reverse ctermfg=236 ctermbg=NONE gui=reverse guifg=#1d1d1d guibg=#8a8a8a
