...
let s:cdBack = {'gui': '#171717', 'cterm': s:cterm00, 'cterm256': '234'}

let s:cdTabCurrent = {'gui': '#171717', 'cterm': s:cterm00, 'cterm256': '234'}
let s:cdTabOther = {'gui': '#2D2D2D', 'cterm': s:cterm01, 'cterm256': '236'}
let s:cdTabOutside = {'gui': '#252526', 'cterm': s:cterm01, 'cterm256': '235'}

let s:cdLeftDark = {'gui': '#171717', 'cterm': s:cterm01, 'cterm256': '235'}
...
let s:cdCursorDark = {'gui': '#4c4c4c', 'cterm': s:cterm03, 'cterm256': '239'}
...
let s:cdSearchCurrent = {'gui': '#afafaf', 'cterm': s:cterm09, 'cterm256': '236'}
let s:cdSearch = {'gui': "#afafaf", 'cterm': s:cterm0A, 'cterm256': '236'}
...
call <sid>hi('MatchParen', s:cdNone, s:cdNone, 'none', {})
