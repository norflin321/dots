...
hi Normal guifg=#bfc9d8 ctermfg=146 guibg=#15212a ctermbg=235
...
hi Comment guifg=#87919d ctermfg=60 gui=NONE cterm=NONE
...
hi Conceal guifg=#82aaa3 ctermfg=138 guibg=#222433 ctermbg=235 gui=NONE cterm=NONE
...
hi Directory guifg=#82aaa3 ctermfg=144
...
hi Title guifg=#82aaa3 ctermfg=144 gui=bold cterm=bold
hi Keyword guifg=#82aaa3 ctermfg=138
hi Identifier guifg=#82aaa3 ctermfg=138
hi Exception guifg=#82aaa3 ctermfg=144
hi Type guifg=#82aaa3 ctermfg=144 gui=NONE cterm=NONE
hi TypeDef guifg=#82aaa3 ctermfg=144 gui=NONE cterm=NONE
...
hi WarningMsg guifg=#82aaa3 ctermfg=138 gui=bold cterm=bold
hi MoreMsg guifg=#73c1a9 ctermfg=79
hi Todo guifg=#82aaa3 ctermfg=144 guibg=NONE ctermbg=NONE gui=bold cterm=bold
...
hi SpellRare guifg=#82aaa3 ctermfg=144 gui=underline cterm=underline
...
hi DiagnosticWarn guifg=#82aaa3 ctermfg=138
hi DiagnosticVirtualTextWarn guifg=#82aaa3 ctermfg=138 gui=bold cterm=bold
hi DiagnosticUnderlineWarn guifg=#82aaa3 ctermfg=138 gui=underline cterm=underline
...
hi htmlSpecialTagName guifg=#82aaa3 ctermfg=138
...
hi pythonStatement guifg=#82aaa3 ctermfg=138
hi pythonBuiltin guifg=#59b6b6 ctermfg=73
hi pythonRepeat guifg=#82aaa3 ctermfg=138
hi pythonOperator guifg=#82aaa3 ctermfg=138
...
hi cPreCondit guifg=#82aaa3 ctermfg=138
hi cIncluded guifg=#b871b8 ctermfg=133
hi cStorageClass guifg=#82aaa3 ctermfg=138
hi cppStructure guifg=#b871b8 ctermfg=133
hi cppSTLnamespace guifg=#82aaa3 ctermfg=138
hi csStorage guifg=#82aaa3 ctermfg=138
hi csModifier guifg=#929be5 ctermfg=104
hi csClass guifg=#929be5 ctermfg=104
hi csClassType guifg=#b871b8 ctermfg=133
hi csNewType guifg=#82aaa3 ctermfg=138
hi rubyConstant guifg=#82aaa3 ctermfg=138
...
hi NvimTreeGitDirty guifg=#82aaa3 ctermfg=144 gui=NONE cterm=NONE
hi NvimTreeGitStaged guifg=#7cbe8c ctermfg=108 gui=NONE cterm=NONE
hi NvimTreeGitMerge guifg=#82aaa3 ctermfg=144 gui=NONE cterm=NONE
hi NvimTreeGitRenamed guifg=#82aaa3 ctermfg=144 gui=NONE cterm=NONE
...
hi NvimTreeBookmark guifg=#82aaa3 ctermfg=144 gui=NONE cterm=NONE
...
hi GitGutterChange guifg=#82aaa3 ctermfg=144
...
hi ALEWarningSign guifg=#82aaa3 ctermfg=138 gui=bold cterm=bold
...
hi CocWarningSign guifg=#82aaa3 ctermfg=138 gui=bold cterm=bold
...
hi LspWarning guifg=#82aaa3 ctermfg=138
hi LspWarningText guifg=#82aaa3 ctermfg=138 gui=bold cterm=bold
hi LspWarningHighlight gui=underline cterm=underline
hi LspWarningVirtualText guifg=#82aaa3 ctermfg=138 gui=bold cterm=bold
...
hi TelescopeMultiIcon guifg=#82aaa3 ctermfg=144
hi TelescopeMultiSelection guifg=#82aaa3 ctermfg=144
...
hi EasyMotionTarget guifg=#82aaa3 ctermfg=144 gui=bold cterm=bold
...
if has("nvim")
  ...
  let g:terminal_color_11 = '#82aaa3'
...
if has("nvim-0.8.0")
  ...
  hi @text.title guifg=#82aaa3 ctermfg=144 gui=bold cterm=bold
  ...
  hi @type guifg=#82aaa3 ctermfg=138
  hi @type.builtin guifg=#82aaa3 ctermfg=138
  hi @include guifg=#929be5 ctermfg=104
  hi @variable guifg=#9ea3c0 ctermfg=146
  hi @variable.builtin guifg=#82aaa3 ctermfg=138
  ...
  hi @lsp.type.interface guifg=#82aaa3 ctermfg=138
  ...
  hi @lsp.type.type guifg=#82aaa3 ctermfg=138
