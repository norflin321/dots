...
if !has("gui_running")
		...
		if has("gui_running") || &t_Co == 88 || &t_Co == 256
				...
				if version >= 700
						...
						call <SID>X("CursorColumn", "", "none", "none")
						call <SID>X("PMenu", s:foreground, s:selection, "none")
						call <SID>X("PMenuSel", s:foreground, s:selection, "reverse")
						call <SID>X("SignColumn", "", "none", "none")
						end
						if version >= 703
								call <SID>X("ColorColumn", "", "none", "none")
								end
								...
								call <SID>X("@lsp.type.namespace", s:foreground, "", "none")
								call <SID>X("@lsp.type.enumMember", s:foreground, "", "none")
